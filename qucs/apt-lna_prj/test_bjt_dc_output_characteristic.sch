...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=test_bjt_dc_output_characteristic.dat>
  <DataDisplay=test_bjt_dc_output_characteristic.dpl>
  <OpenDisplay=1>
  <Script=test_bjt_dc_output_characteristic.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <.SW SW2 1 890 160 0 77 0 0 "DC1" 1 "lin" 1 "Vce" 1 "0" 1 "5" 1 "101" 1>
  <Vdc V1 1 580 210 18 -26 0 1 "Vce" 1>
  <.SW SW1 1 710 160 0 77 0 0 "SW2" 1 "lin" 1 "Ib" 1 "10u" 1 "200u" 1 "11" 1>
</Components>
<Wires>
